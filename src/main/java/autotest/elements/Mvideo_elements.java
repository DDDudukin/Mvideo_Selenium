...
public class Mvideo_elements {
    ...
    public static String CheckFilterFrequency = "//span[text()=' Тактовая частота ']";
    public static String CheckBoxesFrequency = "(//span[text()=' Тактовая частота ']//ancestor::label/following-sibling::div//a)";
